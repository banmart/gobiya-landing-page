/**
 * Supabase seed script: inserts/upserts the what-is-the-difference-between-a-manual-action-and-an-algorithmic-penalty article.
 *
 * Run from the project root:
 *   node scripts/seed-manual-vs-algorithmic-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-what-is-the-difference-between-a-manual-action-and-an-algorithmic-penalty.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/what-is-the-difference-between-a-manual-action-and-an-algorithmic-penalty');
}

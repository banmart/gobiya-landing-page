/**
 * Supabase seed script: inserts/upserts the B2B Sales Pipeline Automation article.
 * 
 * Run from the project root:
 *   node scripts/seed-automation-article.mjs
 * 
...
const article = {
  ...
  image_url: '/images/article-b2b-sales-pipeline-automation.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/b2b-sales-pipeline-automation');
}

/**
 * Supabase seed script: inserts/upserts the multi-city website structure article.
 *
 * Run from the project root:
 *   node scripts/seed-multi-city-website-structure-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-multi-city-website-structure.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/best-website-structure-multiple-locations-different-cities');
}

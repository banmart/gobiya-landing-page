/**
 * Supabase seed script: inserts/upserts the what-is-generative-engine-optimization-and-how-does-it-work article.
 *
 * Run from the project root:
 *   node scripts/seed-what-is-geo-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-what-is-generative-engine-optimization-and-how-does-it-work.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/what-is-generative-engine-optimization-and-how-does-it-work');
}

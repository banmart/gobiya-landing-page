/**
 * Supabase seed script: inserts/upserts the how-do-b2b-companies-use-seo-to-generate-predictable-revenue article.
 *
 * Run from the project root:
 *   node scripts/seed-how-b2b-companies-use-seo-to-generate-predictable-revenue-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-how-do-b2b-companies-use-seo-to-generate-predictable-revenue.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/how-do-b2b-companies-use-seo-to-generate-predictable-revenue');
}

/**
 * Supabase seed script: inserts/upserts the chatgpt-vs-google-for-business-discovery article.
 *
 * Run from the project root:
 *   node scripts/seed-chatgpt-vs-google-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-chatgpt-vs-google-for-business-discovery.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/chatgpt-vs-google-for-business-discovery');
}

/**
 * Supabase seed script: inserts/upserts the google-business-profile-optimization article.
 *
 * Run from the project root:
 *   node scripts/seed-google-business-profile-optimization-article.mjs
 *
...
const article = {
  ...
  image_url: '/images/article-google-business-profile-optimization.webp',
  image_path: null,
  featured: true,
};
...
async function seed() {
  ...
  console.log('   URL: https://www.gobiya.com/insights/google-business-profile-optimization');
}

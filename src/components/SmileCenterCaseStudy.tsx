        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '17rem 5vw 5rem', width: '100%' }}>
          <div className="max-w-[1440px] w-full mx-auto flex flex-col justify-end" style={{ minHeight: '30vh' }}>
            ...
            <h1 className="hero-title text-[clamp(1.5rem,5.5vw,3.2rem)] sm:text-[clamp(1.8rem,4.5vw,3.8rem)] font-medium leading-[1.15] tracking-[-0.03em] max-w-[1100px]" style={{ color: '#ffffff' }}>
              ...
              <span className="line"><span><span style={{ color: '#d1f851' }}>5x patient inquiries</span></span></span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 lg:gap-20 items-start">
            <div>
              ...
              <div data-anim="up" className="flex flex-col gap-6 text-[15px] sm:text-[16px] leading-[1.75] text-gray-600">
                ...
                <p>
                  A single, slow, generic site funneled every visitor into the same place, with no clear path to the <em className="text-gray-900 not-italic font-medium">nearest</em> office and no friction-free way to book or call.
                </p>
                <p>
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="mt-14 sm:mt-20 relative aspect-[16/7] overflow-hidden border border-gray-200">
            <ParallaxMedia
              ...
              className="w-full h-full object-cover"
            />
            <div className="absolute bottom-4 left-4 right-4 bg-[#111827]/90 text-white p-4 backdrop-blur-sm max-w-fit">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-20">
            <div className="flex flex-col gap-10">
              ...
              <div>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[12px] font-mono font-semibold text-[#d1f851] uppercase tracking-wider">Local Search Dominance</span>
                </div>
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-100 tracking-tight mb-6">
                ...
                <div className="mt-6 border border-white/10 overflow-hidden">
                  <div className="bg-white/5 px-5 py-3 grid grid-cols-[1fr_100px] text-[11px] uppercase tracking-widest text-gray-400 font-semibold font-mono">
                    <span>Search Query</span>
                    <span className="text-right">Position</span>
                  </div>
                  {localRankings.map((r) => (
                    <div key={r.query} className="px-5 py-4 grid grid-cols-[1fr_100px] border-t border-white/10 items-center">
                      <span className="text-[14px] text-gray-400 font-mono">"{r.query}"</span>
                      <span className="text-right text-[14px] font-bold text-[#d1f851] font-mono">{r.position}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[12px] font-mono font-semibold text-[#d1f851] uppercase tracking-wider">Top-of-Funnel Reach</span>
                </div>
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-100 tracking-tight mb-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="border border-white/10 p-7 bg-white/[0.03]">
                <p className="text-[10px] font-mono uppercase tracking-widest text-gray-400 mb-5 font-semibold">Phase Two Focus</p>
              ...
              <div className="border border-white/10 p-7 bg-white/[0.03]">
                <p className="text-[10px] font-mono uppercase tracking-widest text-gray-400 mb-5 font-semibold">A Note on the Data</p>
                <p className="text-gray-400 text-[14px] leading-[1.7]">

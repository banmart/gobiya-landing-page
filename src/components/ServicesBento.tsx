      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-auto md:auto-rows-[340px]">
          ...
          <motion.div 
            ...
            className="md:col-span-2 cursor-pointer h-full"
          >
            <BorderGlow
          ...
          <motion.div 
            whileHover={{ scale: 0.98 }}
            transition={{ type: "spring", stiffness: 400, damping: 30 }}
            className="md:col-span-1 cursor-pointer h-full"
          >
            <BorderGlow
              backgroundColor="#1a1c23"
              glowColor="23 90 54"
          ...
          <motion.div 
            whileHover={{ scale: 0.98 }}
            transition={{ type: "spring", stiffness: 400, damping: 30 }}
            className="md:col-span-2 bg-gradient-to-br from-[#F26522] to-[#c74c15] rounded-2xl p-8 sm:p-12 relative overflow-hidden group cursor-pointer"
          >

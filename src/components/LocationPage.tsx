...
const LOCATION_DATA: Record<string, LocationData> = {
  ...
  '/locations/glendale-seo': {
    ...
    state: 'CA',
    slug: 'glendale-seo',
    metaTitle: 'Glendale SEO Agency & Services — Organic Traffic & B2B Pipeline | Gobiya',
    metaDescription: 'Dominate local search with Gobiya, the premier Glendale SEO agency. We deliver forensic SEO, B2B lead generation, and AI visibility for Glendale businesses.',
    h1: 'Glendale SEO: We engineer search dominance for Glendale businesses.',
    subHeadline: 'Our Glendale SEO services deliver forensic audits, topical authority architectures, and automated B2B pipelines — built for Glendale companies competing across Los Angeles and beyond.',
    ...
    executionSteps: [
      ...
      { title: 'Content Cluster Deployment', content: 'We publish topically rich pillar pages covering your Glendale service categories, linked to supporting spoke articles that capture long-tail queries and earn featured snippet positions.' },
  ...
  '/locations/burbank-seo': {
    ...
    state: 'CA',
    slug: 'burbank-seo',
    metaTitle: 'Burbank SEO Agency & Services — Media, Entertainment & B2B Growth | Gobiya',
    metaDescription: 'Dominate local search with Gobiya, the leading Burbank SEO agency. We engineer forensic SEO, B2B pipelines, and AI-optimized content for Burbank businesses.',
    h1: 'Burbank SEO: We engineer organic search dominance for Burbank businesses.',
    subHeadline: 'Our Burbank SEO services deliver technical audits, topical authority architectures, and AI-optimized content — built for Burbank companies competing in the entertainment, tech, and professional services markets.',
    heroImage: '/images/location-los-angeles.webp',
    population: '104,000',
    ...
    faqs: [
      ...
      { question: 'How do you approach B2B lead generation in Burbank?', answer: 'We combine SEO-driven inbound with automated outbound pipeline systems. We identify in-market Burbank and LA businesses showing intent signals and trigger personalized outreach sequences to book qualified meetings.' },
  ...
  '/locations/pasadena-seo': {
    ...
    state: 'CA',
    slug: 'pasadena-seo',
    metaTitle: 'Pasadena SEO Agency & Services — Healthcare, Education & B2B Growth | Gobiya',
    metaDescription: 'Partner with Gobiya, the top Pasadena SEO agency. We deliver forensic SEO, entity-level content architectures, and B2B pipeline engineering for Pasadena businesses.',
    h1: 'Pasadena SEO: We engineer organic growth for Pasadena businesses.',
    subHeadline: 'Our Pasadena SEO services deliver forensic audits, entity-level content architectures, and automated B2B pipelines — engineered for Pasadena healthcare, tech, and professional services companies.',
    heroImage: '/images/location-los-angeles.webp',
    population: '138,000',
  ...
  '/locations/long-beach-seo': {
    ...
    state: 'CA',
    slug: 'long-beach-seo',
    metaTitle: 'Long Beach SEO Agency & Services — Port, Logistics & B2B Pipeline | Gobiya',
    metaDescription: 'Reclaim organic dominance with Gobiya, the premier Long Beach SEO agency. We engineer forensic SEO, B2B pipeline automation, and AI visibility for Long Beach businesses.',
    h1: 'Long Beach SEO: We engineer search dominance for Long Beach businesses.',
    subHeadline: 'Our Long Beach SEO services deliver forensic audits, B2B pipeline automation, and AI visibility engineering — built for Long Beach logistics, healthcare, and professional services companies.',
    heroImage: '/images/location-los-angeles.webp',
    population: '466,000',
  ...
  '/locations/anaheim-seo': {
    ...
    state: 'CA',
    slug: 'anaheim-seo',
    metaTitle: 'Anaheim SEO Agency & Services — Hospitality, Tourism & B2B Growth | Gobiya',
    metaDescription: 'Partner with Gobiya, the leading Anaheim SEO agency. We engineer forensic SEO, AI visibility, and B2B pipelines for Anaheim businesses.',
    h1: 'Anaheim SEO: We engineer search dominance for Anaheim businesses.',
    subHeadline: 'Our Anaheim SEO services deliver forensic audits, AI visibility, and automated B2B pipelines — built for Anaheim hospitality, healthcare, and professional services companies competing in Orange County.',
  ...
  '/locations/costa-mesa-seo': {
    ...
    state: 'CA',
    slug: 'costa-mesa-seo',
    metaTitle: 'Costa Mesa SEO Agency & Services — Fashion, Retail & B2B Growth | Gobiya',
    metaDescription: 'Reclaim local search with Gobiya, the premier Costa Mesa SEO agency. We deliver forensic SEO, B2B pipelines, and AI citation engineering for Costa Mesa businesses.',
    h1: 'Costa Mesa SEO: We engineer search dominance for Costa Mesa businesses.',
    subHeadline: 'Our Costa Mesa SEO services deliver forensic audits, topical authority content, and AI citation engineering — built for Costa Mesa retail, fashion, healthcare, and professional services companies.',
    heroImage: '/images/location-orange-county.webp',
    population: '115,000',
    businessCount: '9,000+',
    ...
    approach: [
      ...
      { icon: Trophy, title: 'Coastal corridor coverage.', desc: 'We extend your search authority to cover Newport Beach, Huntington Beach, Irvine, and the broader OC market — maximizing your addressable audience.' },
    ],
    valueCards: [
  ...
  '/locations/irvine-seo': {
    ...
    state: 'CA',
    slug: 'irvine-seo',
    metaTitle: 'Irvine SEO Agency & Services — Tech, SaaS & Enterprise B2B Growth | Gobiya',
    metaDescription: 'Scale organic traffic with Gobiya, the top Irvine SEO agency. We engineer forensic SEO, AI citation engineering, and enterprise B2B pipelines for Irvine businesses.',
    h1: 'Irvine SEO: We engineer enterprise search dominance for Irvine businesses.',
    subHeadline: 'Our Irvine SEO services deliver technical audits, AI citation engineering, and enterprise B2B pipeline automation — built for Irvine\'s technology, SaaS, and professional services companies.',
    heroImage: '/images/location-orange-county.webp',
    population: '307,000',
  ...
  '/locations/santa-ana-seo': {
    ...
    state: 'CA',
    slug: 'santa-ana-seo',
    metaTitle: 'Santa Ana SEO Agency & Services — Legal, Healthcare & B2B Growth | Gobiya',
    metaDescription: 'Dominate local search with Gobiya, the leading Santa Ana SEO agency. We engineer forensic SEO, bilingual content architectures, and B2B pipelines for Santa Ana businesses.',
    h1: 'Santa Ana SEO: We engineer search dominance for Santa Ana businesses.',
    subHeadline: 'Our Santa Ana SEO services deliver forensic audits, bilingual content architectures, and automated B2B pipelines — built for Santa Ana legal, healthcare, financial, and professional services companies.',
    heroImage: '/images/location-orange-county.webp',
    population: '310,000',

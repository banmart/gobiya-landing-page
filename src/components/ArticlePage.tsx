...
└── metrics/
    ...
    └── dau_churn.md   # Daily Active Users & churn calculation formula`}
        ...
        <ul className="list-disc pl-6 mb-8 space-y-2 text-gray-700">
          ...
          <li>
            <a href="/case-studies" className="text-gray-900 underline underline-offset-4 hover:text-gray-600 transition-colors">SmileCenter Dentistry case study</a>
          </li>
          <li>

  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#050505] flex flex-col justify-center items-center px-5 sm:px-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-[#F26522]/10 to-transparent pointer-events-none" />
        ...
        <div className="max-w-2xl w-full bg-black/40 border border-white/10 p-8 sm:p-14 rounded-2xl shadow-2xl backdrop-blur-md text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              href="/" 
              className="flex items-center gap-2 bg-[#F26522] hover:bg-[#e05a1a] text-white px-6 py-3.5 rounded font-medium text-[14px] transition-colors duration-300 w-full sm:w-auto justify-center"
            >

...
const REGIONAL_HUBS: Record<string, RegionalHubData> = {
  ...
  'glendale': {
    ...
    heroSubheadline: 'Gobiya engineers hyper-local search visibility, Google map-pack dominance, and AI engine recommendations (GEO) for Glendale businesses and regional brands looking to win the Jewel City.',
  ...
  'beverly-hills': {
    ...
    heroSubheadline: 'Gobiya engineers high-end search dominance, AI search recommendations, and premium inbound pipelines for elite Beverly Hills businesses and luxury brands.',
  ...
  'northridge': {
    ...
    heroSubheadline: 'We engineer top-3 Google Map rankings, local pack conversions, and AI search presence for Northridge businesses and Valley-wide enterprises.',
  ...
  'studio-city': {
    ...
    heroSubheadline: 'Gobiya engineers high-visibility search, Google Maps local pack rankings, and generative engine optimization (GEO) for Studio City agencies and creative brands.',

...
const REGIONAL_HUBS: Record<string, RegionalHubData> = {
  'southern-california': {
    ...
    spokes: [
      {
        href: '/services/seo',
        label: 'Technical SEO for SoCal Enterprises',
        icon: <Search size={36} className="text-[#F26522] mb-6" strokeWidth={1.5} />,
        description: 'Entity-level SEO audits, topical authority architectures, and Core Web Vitals remediation — built for the hyper-competitive Southern California search landscape.',
        highlight: false,
      },
      {
      ...
      },
      {
        ...
        label: 'Silicon Beach Penalty Recovery',
        icon: <ShieldAlert size={36} className="text-white mb-6" strokeWidth={1.5} />,
        description: 'SaaS and tech brands devastated by algorithmic updates get forensic recovery protocols engineered to restore traffic and pipeline within 90 days.',
        highlight: false,
      },
      {
        href: '/services/lead-generation',
        label: 'B2B Pipeline for LA Mid-Market',
        icon: <Target size={36} className="text-white mb-6" strokeWidth={1.5} />,
        description: 'Automated cold outreach and intent-signal routing to book meetings with decision-makers at LA-based enterprise accounts on autopilot.',
        highlight: false,
      },
      {
        href: '/services/ppc-advertising',
        label: 'High-ROAS Paid Search — SoCal',
        icon: <TrendingUp size={36} className="text-white mb-6" strokeWidth={1.5} />,
        description: 'Data-driven Google and Meta paid campaigns for Southern California brands that cannot afford to burn budget on impressions instead of pipeline.',
        highlight: false,
      },
      {
        href: '/services/web-development',
        label: 'React Engineering for LA Brands',
        icon: <Zap size={36} className="text-[#F26522] mb-6" strokeWidth={1.5} />,
        description: 'Sub-second React/Vite platforms, Core Web Vitals optimization, and conversion-engineered landing pages that turn SoCal traffic into revenue.',
        highlight: true,
      },
    ],
    schemaJson: {

...
const FAQ_ITEMS = [
  {
    q: 'What is plastic surgery digital marketing?',
    a: 'Plastic surgery digital marketing is the system of channels and strategies a practice uses to get found by prospective patients online, build trust across a 3–6 month consideration cycle, and convert research-stage visitors into booked consultations. It spans SEO (organic search), Google Ads (paid search), content architecture, review management, and reputation signals. Unlike consumer marketing, plastic surgery digital marketing must navigate HIPAA-adjacent privacy norms, platform restrictions on before/after imagery, and FTC disclosure requirements for paid endorsements.',
  },
  {
    q: 'What should a plastic surgery marketing campaign include?',
    a: 'A plastic surgery marketing campaign should include: procedure-specific landing pages targeting high-intent queries ("rhinoplasty Los Angeles cost," "board certified plastic surgeon near me"), Google Ads for same-day-intent searches, content that nurtures the research-phase visitor across multiple sessions, a review acquisition system that generates consistent new patient reviews, and local SEO work that secures Map Pack positions for location-based searches. Campaigns that only run paid ads without the organic and reputation layer produce results that stop the moment the budget stops.',
  },
  {
    q: 'What are the best plastic surgery marketing ideas in 2026?',
    a: 'The highest-return plastic surgery marketing ideas in 2026 are: (1) procedure-cluster content architecture — deep content hubs around each service that answer the full research journey; (2) AI citation optimization — engineering your brand to appear in ChatGPT, Perplexity, and Google AI Overviews for plastic surgery queries; (3) video consultation content — short, expert-led explainers indexed by Google and cited by AI engines; (4) review velocity systems — repeatable workflows for generating Google and RealSelf reviews after every positive patient interaction; (5) RLSA Google Ads — remarketing to patients who visited procedure pages but didn\'t book.',
  },
  {
    q: 'How do I choose the best plastic surgery internet marketing company?',
    a: 'Choose a plastic surgery internet marketing company based on three things: documented patient acquisition outcomes (not just impressions or clicks — actual consultations booked), experience with medical marketing compliance (HIPAA, FTC, platform policy restrictions on before/after ads), and vertical tenure (have they actually run marketing for plastic surgery practices, or are they repurposing generic healthcare marketing?). Ask for case studies with specific procedure-level ranking data and paid search cost-per-consultation figures. Gobiya is BBB A+ rated and has served medical and aesthetic practice clients since 2012.',
  },
];

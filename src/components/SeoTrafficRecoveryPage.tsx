...
export default function SeoTrafficRecoveryPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '3rem', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div style={{ flex: '1 1 480px', minWidth: 0 }}>
            ...
            <h1 style={{ fontSize: 'clamp(2.5rem, 5.5vw, 4.5rem)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.05, color: '#111827', maxWidth: '920px', marginBottom: '1.5rem' }}>
              SEO Traffic Recovery: Rankings Restored After Google Updates and Penalties
            </h1>
          ...
          <div style={{ flex: '1 1 460px', maxWidth: '560px' }}>
            <HeroQuickForm source="SEO Traffic Recovery" variant="light" heading="Get a free traffic-drop read" subheading="Tell us what happened and we'll send a quick diagnosis." />
          </div>
        </div>
      </section>
      ...
      <ContentCta headline="Lost traffic? We know how to get it back." sub="Our team responds within one business day." accent="#111827" background="#ffffff" />
      ...
      <section style={{ padding: '5rem 5vw', borderBottom: '1px solid #e5e7eb', background: '#ffffff' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '3rem', alignItems: 'center', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ flex: '1 1 340px' }}>
            <span style={{ fontFamily: 'monospace', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.18em', color: '#9ca3af', display: 'block', marginBottom: '0.75rem' }}>Free diagnosis</span>
            <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 2rem)', fontWeight: 700, letterSpacing: '-0.03em', color: '#111827', lineHeight: 1.2, marginBottom: '1rem' }}>
              Get a free traffic recovery audit
            </h2>
            <p style={{ fontSize: '0.95rem', color: '#374151', lineHeight: 1.75, marginBottom: '1.25rem' }}>
              Tell us about your site and what changed. We'll identify the likely cause of your traffic drop and send a prioritized recovery roadmap within 24 hours.
            </p>
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', padding: 0, margin: 0, listStyle: 'none' }}>
              {['Google update impact assessment', 'Penalty signal identification', 'Prioritized recovery roadmap'].map(item => (
                <li key={item} style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', fontSize: '0.875rem', color: '#374151' }}>
                  <span style={{ color: '#111827', fontWeight: 700, fontSize: '1rem' }}>?</span> {item}
                </li>
              ))}
            </ul>
          </div>
          <div style={{ flex: '1 1 420px', maxWidth: '560px' }}>
            <HeroQuickForm source="Traffic Recovery Mid-Content Audit" variant="light" heading="Request your free diagnosis" subheading="No commitment. Response within 24 hours." showLogos={false} />
          </div>
        </div>
      </section>
      ...
      <ContentCta headline="Let's diagnose your traffic drop." sub="Start with a free site audit — no commitment, 24-hour response." accent="#111827" background="#f9fafb" />

...
3. [Scale — lock in the growth](/approach/scale.md)

The guiding principles are signal forensics, decisive execution, and zero latency — read the signal, map the damage, and move, rather than waiting for the next update.
